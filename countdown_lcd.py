...
import smbus  # For I2C communication with the LCD
...
class CountdownTimer:
    def __init__(self, root):
        ...
        # Initialize the LCD
        self.lcd_address = 0x27  # Replace with your LCD's I2C address
        self.bus = smbus.SMBus(1)  # I2C bus number (1 for most Raspberry Pi models)
        self.init_lcd()
    ...
    def init_lcd(self):
        # Initialize the LCD (adjust commands based on your LCD's datasheet)
        self.bus.write_byte_data(self.lcd_address, 0x00, 0x38)  # Function set
        self.bus.write_byte_data(self.lcd_address, 0x00, 0x0C)  # Display ON
        self.bus.write_byte_data(self.lcd_address, 0x00, 0x01)  # Clear display
        time.sleep(0.1)
